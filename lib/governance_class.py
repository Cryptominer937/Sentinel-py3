...
class GovernanceClass:
    ...
    def list(self):
        ...
        # return a dict similar to swampd "gobject list" output
    ...
    def swampd_serialise(self):
        import swamplib
        return swamplib.SHIM_serialise_for_swampd(self.serialise())
